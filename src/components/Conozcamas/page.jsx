      ...
      <div className="w-11/12 sm:w-10/12 h-full flex flex-col md:flex-row">
        ...
        <div className="md:w-7/12 flex flex-col justify-center md:pl-20 mt-10 md:mt-0">
          <Fade triggerOnce direction="up">
            <h2 className="text-4xl text-[#0315ae] font-bold mb-10 text-center md:text-start">
          ...
          <Fade triggerOnce direction="up">
            <p className="sm:text-lg text-justify mb-10">
              La Sociedad Venezolana de Endoscopia Digestiva es una Asociación
              Médica Científica sin fines de lucro, dedicada a la promoción y
              difusión de la Endoscopia Digestiva dentro de un marco de
              compromiso social y de responsabilidad en el desarrollo de la
              especialidad, con impacto en la salud de la comunidad, que
              propicia el intercambio con instituciones Nacionales e
              Internacionales.
            </p>
          </Fade>
